...
public class ReferenceDTO {
	...
	public String getAreacode_ref() {
		return areacode_ref;
	}
	public void setAreacode_ref(String areacode_ref) {
		this.areacode_ref = areacode_ref;
	}
	public String getSigungucode_ref() {
		return sigungucode_ref;
	}
	public void setSigungucode_ref(String sigungucode_ref) {
		this.sigungucode_ref = sigungucode_ref;
	}
	...
	public void setFirsttrip(char firsttrip) {
