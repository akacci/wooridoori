...
#div_detail .content_detail h3 a {
	color: black
}
#div_detail .content_detail h3:hover {
	background-color: #cccccc
}
</style>
<script type="text/javascript"
	src="<%=request.getContextPath()%>/resources/js/content_detail.js"></script>
...
<body>
	...
	<div class="contents">
		<div id="div_detail">
			...
			<div class="content_detail">
				<h3 class="menu basic_m">
					<a>기본정보</a><span><i id="i" class="fa fa-caret-up"
						style="float: right; margin-right: 10px;"></i></span>
				</h3>
				<div class="info basic_info"></div>
			</div>
			<div class="content_detail">
				<h3 class="menu basic_m">
					<a>상세정보</a><span><i class="fa fa-caret-up"
						style="float: right; margin-right: 10px;"></i></span>
				</h3>
			...
			<div class="content_detail">
				<h3 class="menu">
					<a>지도</a><span><i class="fa fa-caret-down"
						style="float: right; margin-right: 10px;"></i></span>
				</h3>
				<div class="info map_info" id="map_info" style="height: 400px;"></div>
				<script async defer
					src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDinVBIQ_6J72u5Ti9A4YHmCcsXoVZJFgE&callback=initMap"></script>
				<script>
					var map;
					var x = ${cdata.mapx};
					var y = ${cdata.mapy};
