...
String path = request.getSession().getServletContext().getRealPath("/") + File.separator + "save"; // 이미지가 저장될 ; // 이미지가 저장될 주소
String filename = "";
...
<script type="text/javascript">
	function fileAttach(){ 
	    ...
	    fcode = fpath + fname;
	    //http://localhost:8787/MiniProject/se2/2017_07_16_222633.jpg
	    try{
